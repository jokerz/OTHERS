#*******************************
# @file    /etc/sysconfig/jkz-iptables.sh
...
# $Id: jkz-iptables.sh,v 1.0 2010/11/26 19:00 ryo Exp $
...
# SSH 22
iptables -A INPUT -s 192.168.10.0/255.255.255.0 -i eth0 -p tcp -m tcp --dport 22 -j ACCEPT
iptables -A INPUT -s 192.168.10.0/255.255.255.0 -i eth0 -p udp -m udp --dport 22 -j ACCEPT
## UpStair Office
iptables -A INPUT -s 219.119.136.38 -i eth0 -p tcp -m tcp --dport 22 -j ACCEPT
iptables -A INPUT -s 219.119.136.38 -i eth0 -p udp -m udp --dport 22 -j ACCEPT
## My Home
iptables -A INPUT -s 116.64.211.200 -i eth0 -p tcp -m tcp --dport 22 -j ACCEPT
iptables -A INPUT -s 116.64.211.200 -i eth0 -p udp -m udp --dport 22 -j ACCEPT
## For Horiguchi
iptables -A INPUT -s 122.1.17.145 -i eth0 -p tcp -m tcp --dport 22 -j ACCEPT
iptables -A INPUT -s 122.1.17.145 -i eth0 -p udp -m udp --dport 22 -j ACCEPT
## For Horiguchi HomeNet
iptables -A INPUT -s 59.171.238.47 -i eth0 -p tcp -m tcp --dport 22 -j ACCEPT
iptables -A INPUT -s 59.171.238.47 -i eth0 -p udp -m udp --dport 22 -j ACCEPT
...
# SMTP 25
iptables -A INPUT -s 193.168.10.0/255.255.255.0 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 192.168.10.0/255.255.255.0 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
## up-stair.jp
iptables -A INPUT -s 121.119.167.137 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 121.119.167.137 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
## UpStair Office
iptables -A INPUT -s 219.119.136.38 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 219.119.136.38 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
## smtp.up-stair.com
iptables -A INPUT -s 211.13.204.71 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 211.13.204.71 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
iptables -A INPUT -s 211.13.204.14 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 211.13.204.14 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
## jokerz.org Modified 2010/01/06
iptables -A INPUT -s 116.64.211.200 -i eth0 -p tcp -m tcp --dport 25 -j ACCEPT
iptables -A INPUT -s 116.64.211.200 -i eth0 -p udp -m udp --dport 25 -j ACCEPT
